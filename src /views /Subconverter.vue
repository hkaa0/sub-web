  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "增强型后端【vless+hysteria】": "https://sub.66688888.xyz",
        },
        backendOptions: [
          {value: "https://sub.66688888.xyz"},
        ],
        remoteConfig: [
          {
            label: "通用",
